        ...
        <div class="card-body">
            ...
            @endif            
                <div class="input-group">
                    ...
                    <input type="file" class="custom-file-input" name="archivo" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel">
